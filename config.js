const config = {
  gatsby: {
    pathPrefix: '/',
    siteUrl: 'https://foocafe-flutter-chat-codelab.netlify.app/',
    gaTrackingId: null,
    trailingSlash: false,
  },
  header: {
    logo: 'https://foocafe.org/themes/foocafe/src/assets/logo-withtext-color.svg',
    logoLink: 'https://foocafe-flutter-chat-codelab.app/',
    title: 'FOOCAFE',
    githubUrl: 'https://github.com/sumithpdd/foocafe_flutter_chat_codelab',
    helpUrl: '',
    tweetText: '',
    social: `<li>
