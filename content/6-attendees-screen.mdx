...
To store current user data we will create a model -> **`user_data.dart`** 📄 file under **models** 📁 folder it extends ChangeNotifierProvider
...
update main.dart 📄 file **main()** and **import** all the required **packages**
...
import 'package:foocafe_flutter_firebase_chat/services/auth_service.dart';
...
![](https://res.cloudinary.com/sitecore/image/upload/c_limit,q_80,w_2000/v1643884510/foocafe_flutter_chat_codelab/06_01_attendees_screen_zgavhc.png)
...
![](https://res.cloudinary.com/sitecore/image/upload/c_limit,q_80,w_2000/v1643884790/foocafe_flutter_chat_codelab/06__02_appdrawer_hfpc5h.png)
...
![](https://res.cloudinary.com/sitecore/image/upload/c_limit,q_80,w_2000/v1643885298/foocafe_flutter_chat_codelab/06__03_appdrawer_image_olygon.png)
