...
* please check the installation on your mac or PC by running <https://docs.flutter.dev/get-started/install>
  ...
  * upload the screenshot with your name prefix use the link https://github.com/sumithpdd/flutterworkshop/blob/main/Screenshots/
* Please fork this repo https://github.com/sumithpdd/flutterworkshop and run the command - already run in the repo -
...
![](https://res.cloudinary.com/sitecore/image/upload/c_limit,q_80,w_2000/v1643832970/foocafe_flutter_chat_codelab/spd_home_screen_i4av4g.png)
...
https://github.com/sumithpdd/flutterworkshop/tree/main/Screenshots/

### ℹ️ Visual Studio Code Extension
